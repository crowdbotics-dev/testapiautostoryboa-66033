...
## Project Structure
    ...
    ├── testapiautostoryboa_66033  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_66033`
...
2. Clone this repo and `cd testapiautostoryboa_66033`
